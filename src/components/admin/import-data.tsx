...
import { FileDown, FileUp, Loader2, CheckCircle2, AlertCircle, Table as TableIcon } from "lucide-react";
import { toast } from "sonner";
import * as XLSX from "xlsx";
import { importHistoricalSalesAction } from "@/actions/import-actions";
...
export function AdminImportData({ branches }: AdminImportDataProps) {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-20">
            ...
            {/* Preview Section (Optional scrollable) */}
            {previewData.length > 0 && (
