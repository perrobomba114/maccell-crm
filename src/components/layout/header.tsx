...
export function Header({
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-30 md:sticky md:top-0 border-b border-border bg-background/95 backdrop-blur-sm supports-[backdrop-filter]:bg-background/60">
