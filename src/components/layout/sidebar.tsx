...
const iconMap: Record<string, LucideIcon> = {
    LayoutDashboard, Users, Building2, Package, Wrench, ShoppingCart, FileText, Receipt, ClipboardList, Star, List, History, Box, BarChart3, Banknote, Percent, RotateCcw, Settings
};
