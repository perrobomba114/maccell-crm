        ...
        <div className="flex min-h-0 flex-1 flex-col">
            <div className="border-b p-3">
                <div className="grid grid-cols-2 gap-2 rounded-xl bg-muted p-1">
                    <button type="button" onClick={() => changeScope("active")} className={`rounded-lg px-3 py-2 text-sm font-semibold ${chat.scope === "active" ? "bg-background shadow" : "text-muted-foreground"}`}>Activos</button>
                    <button type="button" onClick={() => changeScope("archived")} className={`flex items-center justify-center gap-2 rounded-lg px-3 py-2 text-sm font-semibold ${chat.scope === "archived" ? "bg-background shadow" : "text-muted-foreground"}`}><Archive className="h-4 w-4" />Archivados</button>
                </div>
