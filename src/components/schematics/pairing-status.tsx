...
export function PairingStatus({board,pdf,linked,canEdit,onUpdated}:{board:SchematicAsset;pdf:SchematicAsset;linked:boolean;canEdit:boolean;onUpdated(asset:SchematicAsset):void}){
 ...
 return <div className="sch-notice sch-identity-notice" role="status">
  {linked?'Placa y documento abiertos · las referencias se comprueban al seleccionar.':compatible?'Revisá que estos archivos correspondan a la misma placa y revisión antes de sincronizarlos.':'Estos archivos corresponden a equipos o revisiones diferentes.'}
